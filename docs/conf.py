...
# -*- coding: utf-8 -*-
#
# jenkins-pipeline-library documentation build configuration file, created by
...
#
# html_title = 'jenkins-pipeline-library v2.1.0'
...
htmlhelp_basename = 'jenkins-pipeline-librarydoc'
...
man_pages = [
    (master_doc, 'jenkins-pipeline-library', 'jenkins-pipeline-library Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jenkins-pipeline-library', 'jenkins-pipeline-library Documentation',
     author, 'jenkins-pipeline-library', 'One line description of project.',
     'Miscellaneous'),
]
